...
Agent.prototype.setRequestOptions = function (options) {
...
Agent.prototype.request = function request(url) {
  ...
  if (this._requestOptions && this._requestOptions.dtls && this._requestOptions.dtls==true)
  {
    this._sock.enableDTLS(true);
    if (this._requestOptions.privateKey)
    {
      this._sock.setPrivateKey(this._requestOptions.privateKey);
    }
    if (this._requestOptions.certificate)
    {
      this._sock.setCertificate(this._requestOptions.certificate);
    }
  }
