...
Agent.prototype.request = function request(url) {
  ...
  if (this.requestOptions && this.requestOptions.dtls && this.requestOptions.dtls==true)
  {
    this._sock.enableDTLS(true);
    if (this.requestOptions.privateKey)
    {
      this._sock.setPrivateKey(this.requestOptions.privateKey);
    }
    if (this.requestOptions.certificate)
    {
      this._sock.setCertificate(this.requestOptions.certificate);
    }
  }
